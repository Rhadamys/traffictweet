<template>
    <div class="container">
        <div class="panel-flex" v-bind:class="{ 'full-height': loading || calendar.length === 0 }">
            ...
            <div class="body alert text-center" v-else>
